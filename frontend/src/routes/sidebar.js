...
import { FaTachometerAlt, FaUsers, FaFileInvoiceDollar, FaBalanceScale, FaMoneyBillWave, FaChartLine, FaBook, FaTable, FaPiggyBank, FaCashRegister } from 'react-icons/fa';
      ...
      <div className="w-72 h-screen bg-color-white text-black shadow-xl font-body flex flex-col">
        ...
        <nav className="px-4 py-3 flex-grow">
          <ul className="space-y-1">
            <li className="hover:bg-color-dark-red hover:text-white px-3 py-3 rounded-md font-semibold  ">
