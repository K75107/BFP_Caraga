        ...
        <Fragment>
                    ...
                    <tbody>
                        {trialBalanceList.map((trialbalance) => (
                            <tr
                                ...
                                // onClick={() => navigate(`/main/generalLedger/ledgerDetails/${trialbalance.id}`)}
                            >
                                <th
                                    scope="row"
            ...
            {showDeleteModal && (
                <Modal isVisible={showDeleteModal}>
                    <div className="bg-white w-[400px] rounded py-6 px-6">
                        <h2 className="text-xl font-poppins font-bold text-[#1E1E1E] mb-4">Confirm Deletion</h2>
                        <p className="text-gray-700 mb-6">Are you sure you want to remove this Trial Balance?</p>
                        <div className="flex justify-end space-x-4">
                            <button 
                                className="bg-white border border-gray-300 rounded text-gray-700 font-poppins font-medium py-2 px-4"
                                onClick={() => {
                                    setShowDeleteModal(false);
                                    setDeleteTrialBalanceID(null);
                                }}
                            ...
                            <button 
                                className="bg-red-600 rounded text-white font-poppins font-medium py-2 px-4"
