    ...
    <Fragment>
      <div className="bg-white h-full py-6 px-8 w-full rounded-lg">
        <div className="flex justify-between w-full">
          <h1 className="text-[25px] font-semibold text-[#1E1E1E]">Manage Fire Stations</h1>
          <button 
        ...
        {/* Table to show list of fire stations */}
      ...
      <Modal isVisible={showModal}>
        <div className="bg-white w-[600px] h-auto rounded py-4 px-6">
          <div className="flex justify-between items-center">
            <h1 className="font-bold text-[27px] text-[#1E1E1E]">Add New Fire Station</h1>
